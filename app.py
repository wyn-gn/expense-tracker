...
def open_main_window():
    pin = pin_entry.get()
    if pin == "1234":  # <-- set your PIN here
        pin_window.destroy()  # close PIN window
        main_window()         # open the main Expense Tracker
    else:
...
Label(pin_window, text="Enter PIN", font=("Arial", 14)).pack(pady=20)
pin_entry = Entry(pin_window, show="*", font=("Arial", 12), width=15)
pin_entry.pack(pady=5)

Button(pin_window, text="Submit", bg="#4CAF50", fg="white", command=open_main_window).pack(pady=15)
