...
def expenses_window():
    ...
    ttk.Label(header_frame, text="Daily Expenses Window", font=("Segoe UI Semibold", 16)).grid(row=0, column=0, sticky="nsew")
...
def bills_window():
    ...
    center_window(bills_win, 400, 300)

    ttk.Label(bills_win, text="Bills Window", font=("Segoe UI Semibold", 16)).pack(pady=20)
    ttk.Button(bills_win, text="Back", bootstyle=SECONDARY, command=go_back_to_main_from_bills).pack(pady=10)
...
def debts_window():
    ...
    center_window(debts_win, 400, 300)

    ttk.Label(debts_win, text="Debts Window", font=("Segoe UI Semibold", 16)).pack(pady=20)
    ttk.Button(debts_win, text="Back", bootstyle=SECONDARY, command=go_back_to_main_from_debts).pack(pady=10)
